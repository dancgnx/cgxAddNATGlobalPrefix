...
def go():
    ...
    custom_group = parser.add_argument_group('custom_args', 'Add prefixes to NAT prefix list')
    custom_group.add_argument("--prefix", help="Prefix-list to add to",required=True,
                              default=None, action="store")
    custom_group.add_argument("--list", help="Text file with a prefix per line",type=argparse.FileType("r"),required=True,
                              default=None, action="store")
